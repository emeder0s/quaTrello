...
/*
      <h6 className='title'>{user.full_name}</h6>
      <hr />
      <p className="liPerfil"><Link to="/perfil">Perfil y visibilidad</Link></p>
      <p className="liPerfil"><Link to="/perfil" >Actividad</Link></p>
      <p className="liPerfil"><Link to="/perfil">Tarjetas</Link></p>
      <p className="liPerfil"><Link to="/perfil">Configuración</Link></p>*/