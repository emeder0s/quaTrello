...
const email = {
  ...
  notification: async (user_email_to, user_name_from, operation, element, element_name, into) => {
    var mailOptions = {
      from: 'quatrellothebridge@gmail.com',
      to: user_email_to,
                                                    ...
                                                    <tbody>
                                                        <tr style="padding:0;vertical-align:top;text-align:left"
                                                            ...
                                                            <td class="m_-2668785316594404536phenom-details"
                                                                ...
                                                                valign="top" align="left">
                                                                <strong>${user_name_from}</strong> ha ${operation} ${element} ${element_name} en ${into} 
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
